...
class IndividualAnswersPage extends StatelessWidget {
  ...
  Future<List<dynamic>> fetchIndividualAnswers(int surveyId, int respondentId) async {
    ...
    final response = await http.get(Uri.parse(
        'https://7cab-114-122-79-93.ngrok-free.app/SiDataAPI/api/get_surveys.php?user_id=$userId&action=individual_answers&survey_id=$surveyId&respondent_id=$respondentId'));
